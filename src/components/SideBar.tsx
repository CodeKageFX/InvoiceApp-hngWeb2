...
const SideBar = () => {
  ...
  return (
    <aside className="h-[90px] z-100 md:h-screen sticky top-0 w-screen md:w-[90px] bg-sidebar flex flex-row md:flex-col justify-between items-center md:rounded-r-2xl">
